...
const char *rvText(unsigned long rv)
{
    ...
    case 0x00000003UL: return "слот недоступен — подключите устройство заново и повторите";
    ...
    case 0x00000030UL: return "ошибка устройства — переподключите его и повторите";
    case 0x00000031UL: return "недостаточно памяти в Рутокене";
    case 0x00000032UL: return "устройство убрано во время операции — повторите, удерживая его на связи";
    ...
    case 0x000000B0UL: return "сессия прервана (возможно, устройство убрано) — повторите";
    case 0x000000B1UL: return "слишком много открытых сессий";
    case 0x000000B3UL: return "сессия прервана (возможно, устройство убрано) — повторите";
    ...
    case 0x000000E0UL: return "устройство не подключено — подключите его и повторите";
    case 0x000000E1UL: return "устройство не распознано";
    case 0x000000E2UL: return "Рутокен защищён от записи";
