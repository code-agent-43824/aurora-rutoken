...
const char *rvText(unsigned long rv)
{
    ...
    case 0x00000003UL: return "неверный идентификатор слота";
    ...
    case 0x00000030UL: return "ошибка устройства";
    case 0x00000031UL: return "недостаточно памяти на токене";
    case 0x00000032UL: return "токен отключён во время операции";
    ...
    case 0x000000B0UL: return "сессия закрыта";
    case 0x000000B1UL: return "слишком много открытых сессий";
    case 0x000000B3UL: return "неверный дескриптор сессии";
    ...
    case 0x000000E0UL: return "токен не подключён";
