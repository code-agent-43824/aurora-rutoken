...
Для `code-agent-43824/aurora-rutoken` оба repository secret уже настроены
2026-09-01 и подтверждены успешным полным прогоном. Пункты выше нужны при
ротации ключа, переносе workflow в другой репозиторий или восстановлении
секретов.
